              ...
              <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500/0 to-red-500/0 group-hover:from-orange-500/10 group-hover:to-red-500/10 transition-all duration-500 rounded-xl pointer-events-none z-10" />
                    
                    <Card className="border border-white/10 bg-gray-900/50 backdrop-blur-xl hover:bg-gray-900/70 hover:border-orange-500/50 transition-all duration-500 cursor-pointer overflow-hidden h-full hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/10">
                      {/* Image container */}
